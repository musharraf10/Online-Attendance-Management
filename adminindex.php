...
try {
    ...
    if (isset($_POST['std'])) {
        ...
        $stmt = $mysqli->prepare("INSERT INTO students (st_id, st_name, st_dept, st_batch, st_sem, st_email) VALUES (?, ?, ?, ?, ?, ?)");
...
<body>
  ...
  <div class="row">
    <div class="col-md-12 text-center">
      <h3 class="animate-charcter"> Admin</h3>
    </div>
  </div>
</div>
...
<div class="center-container">
        <img src="assets/img/atte.png" alt="Admin Image" class="center-image">
    </div>
            </div>
        </div>
    </div>
